            ...
            <tr>
                <td valign="top" style="padding:0;Margin:0">
                    <table cellpadding="0" cellspacing="0" class="cc" align="center" role="none"
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table bgcolor="#ffffff" class="cp" align="center" cellpadding="0" cellspacing="0"
                                    role="none"
                                    ...
                                    <tr>
                                        <td align="left"
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%" role="none"
                                                ...
                                                <tr>
                                                    <td class="by" valign="top" align="center"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <img src="https://eniqnom.stripocdn.email/content/guids/CABINET_ef1b6e5e582e1062aafbe995eff7cf0641364f014e426b53246a07eff451ff53/images/group_302.png"
                                                                        alt="Logo"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" class="ck"
                                                                    ...
                                                                    <h1
                                                                        style="Margin:0;line-height:55.2px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:46px;font-style:normal;font-weight:bold;color:#333333">
                                                                        Thanks for being my friend!</h1>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left"
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Got a question? Email me at <a target="_blank"
                                                                            href="mailto:kenn@kenndeclouv.my.id"
                                                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:14px;line-height:21px">kenn@kenndeclouv.my.id</a>
                                                                        or give us a call at <a target="_blank"
                                                                            ...
                                                                            href="tel:+62081336446666">here</a></p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        <br>Thanks,
                                                                    </p>
                    ...
                    <table cellpadding="0" cellspacing="0" class="cd" align="center" role="none"
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table class="cn" align="center" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0"
                                                                        class="bp bo" role="presentation"
                                                                        style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                                        <tr>
                                                                            <td align="center" valign="top"
                                                                                style="padding:0;Margin:0;padding-right:40px">
                                                                                <a target="_blank"
                                                                                    href="https://facebook.com/kenndeclouv"
                                                                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#333333;font-size:12px"><img
                                                                                        title="Facebook"
                                                                                        src="https://eniqnom.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png"
                                                                                        alt="Fb" width="32"
                                                                            ...
                                                                            <td align="center" valign="top"
                                                                                style="padding:0;Margin:0;padding-right:40px">
                                                                                <a target="_blank"
                                                                                    href="https://x.com/kenndeclouv"
                                                                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#333333;font-size:12px"><img
                                                                                        title="Х"
                                                                                        src="https://eniqnom.stripocdn.email/content/assets/img/social-icons/logo-black/x-logo-black.png"
                                                                                        alt="Х" width="32"
                                                                                        style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"></a>
                                                                            </td>
                                                                            <td align="center" valign="top"
                                                                                style="padding:0;Margin:0"><a
                                                                                    target="_blank"
                                                                                    href="https://instagram.com/kennndeclouv"
                                                                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#333333;font-size:12px"><img
                                                                                        title="Instagram"
                                                                                        src="https://eniqnom.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png"
                                                                                        alt="Inst" width="32"
                                                                                        style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"></a>
                                                                            </td>
                                                                        </tr>
