...
class KenndeclouvSlider {
  constructor(t, e = {}) {
    if ((this.bindAll(), this.isElement(t)))
      (this.el = t), (this.el._slider = this);
    else {
      const i = document.querySelectorAll(t);
      for (let t = 0; t < i.length; t++) {
        let s = i[t];
        if (0 == t) (this.el = s), (this.el._slider = this);
        else {
          new KenndeclouvSlider(s, e);
        }
      }
    }
    (this.opts = Object.assign(
      {
        ...
        eventTarget: ".kenndeclouv-slider",
        inner: ".kenndeclouv-slider-viewport",
        slides: ".kenndeclouv-slide",
        clones: "kenndeclouv-slide-clone",
        snap: !1,
      ...
      this.isObject(this.opts.navigation) ||
        (1 == this.opts.navigation &&
          ((this.btnNext = this.el.querySelector(".kenndeclouv-button-next")),
          (this.btnPrev = this.el.querySelector(".kenndeclouv-button-prev")))),
      this.isObject(this.opts.navigation) &&
      ...
      this.isObject(this.opts.pagination) ||
        (1 == this.opts.pagination &&
          (this.elPagination = this.el.querySelector(".kenndeclouv-pagination"))),
      this.isObject(this.opts.pagination) &&
      ...
      this.init(),
      KenndeclouvSlider.instances.push(this);
  }
  bindAll() {
    [
      "onDown",
  ...
  setup() {
    ...
    if (null != this.elPagination)
      for (let e = 0; e < t.length; e++) {
        ...
        i.classList.add("kenndeclouv-pagination-bullet"),
  ...
  updateUI() {
    ...
    for (let a = 0; a < this.items.length; a++) {
      ...
      if (
        (Math.abs(o) < h.length / 2
          ? (h.el.classList.add("kenndeclouv-slide-active"),
            h.nextElement.el.classList.add("kenndeclouv-slide-next"),
            h.nextElement.nextElement.el.classList.add("kenndeclouv-slide-next-two"),
            h.nextElement.nextElement.nextElement.el.classList.add(
              "kenndeclouv-slide-next-three"
            ),
            h.prevElement.el.classList.add("kenndeclouv-slide-prev"),
            h.prevElement.prevElement.el.classList.add("kenndeclouv-slide-prev-two"),
            h.prevElement.prevElement.prevElement.el.classList.add(
              "kenndeclouv-slide-prev-three"
            ),
          ...
          : (h.el.classList.remove("kenndeclouv-slide-active"),
            h.nextElement.el.classList.remove("kenndeclouv-slide-next"),
            h.nextElement.nextElement.el.classList.remove(
              "kenndeclouv-slide-next-two"
            ),
            h.nextElement.nextElement.nextElement.el.classList.remove(
              "kenndeclouv-slide-next-three"
            ),
            h.prevElement.el.classList.remove("kenndeclouv-slide-prev"),
            h.prevElement.prevElement.el.classList.remove(
              "kenndeclouv-slide-prev-two"
            ),
            h.prevElement.prevElement.prevElement.el.classList.remove(
              "kenndeclouv-slide-prev-three"
            )),
        h.end + r > e && h.start + r < t + e
          ? h.el.classList.add("kenndeclouv-slide-visible")
          : h.el.classList.remove("kenndeclouv-slide-visible"),
        h.translate != r)
      ) {
    ...
    this.state.flags.dragging
      ? this.el.classList.add("kenndeclouv-state-dragging")
      : this.el.classList.remove("kenndeclouv-state-dragging"),
  ...
  updatePaginationUI() {
    if (
      ...
      null != i && i.el.classList.add("kenndeclouv-pagination-bullet-active");
      let s = e - 1;
      s < 0 && (s = this.itemsPagination.length - 1);
      let n = this.itemsPagination[s];
      null != n && n.el.classList.add("kenndeclouv-pagination-bullet-prev");
      let l = e + 1;
      l >= this.itemsPagination.length && (l = 0);
      let a = this.itemsPagination[l];
      null != a && a.el.classList.add("kenndeclouv-pagination-bullet-next");
      for (let t = 0; t < this.itemsPagination.length; t++) {
        let i = this.itemsPagination[t];
        t != e && i.el.classList.remove("kenndeclouv-pagination-bullet-active"),
          t != l && i.el.classList.remove("kenndeclouv-pagination-bullet-next"),
          t != s && i.el.classList.remove("kenndeclouv-pagination-bullet-prev");
      }
    }
  }
  parallax() {
